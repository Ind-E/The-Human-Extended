...
import static humanextended.util.GeneralUtils.removePrefix;
import static humanextended.util.TextureLoader.getCardTextureString;
...
public abstract class BaseCard extends CustomCard {
    ...
    protected void dmg(AbstractMonster m, AbstractGameAction.AttackEffect fx) {
        Wiz.atb(new DamageAction(m, new DamageInfo(AbstractDungeon.player, damage, damageTypeForTurn), fx));
    }

    protected void dmgTop(AbstractMonster m, AbstractGameAction.AttackEffect fx) {
        Wiz.att(new DamageAction(m, new DamageInfo(AbstractDungeon.player, damage, damageTypeForTurn), fx));
    }

    protected void allDmg(AbstractGameAction.AttackEffect fx) {
        Wiz.atb(new DamageAllEnemiesAction(AbstractDungeon.player, multiDamage, damageTypeForTurn, fx));
    }

    protected void allDmgTop(AbstractGameAction.AttackEffect fx) {
        Wiz.att(new DamageAllEnemiesAction(AbstractDungeon.player, multiDamage, damageTypeForTurn, fx));
    }

    protected void blck() {
        Wiz.atb(new GainBlockAction(AbstractDungeon.player, AbstractDungeon.player, block));
    }
}